...
<template>
    <div :class="!$q.screen.sm && !$q.screen.xs && 'q-pl-xl q-pr-xl'" class="bg-grey-10 text-white q-pa-md">
        <div class="row justify-center">
            <div class="q-ma-md">
                <Title textColor="text-white" title="SKILLS" description="HERE IS MY ARMAMENT"></Title>
            </div>
        </div>
